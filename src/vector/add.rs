...
mod tests {
    ...
    #[test]
    fn vector_add_vector_should_return_vector() {
        let (x1, y1, z1) = (1., 2., 3.);
    ...
    #[test]
    fn vector_add_ref_vector_should_return_vector() {
        let (x1, y1, z1) = (1., 2., 3.);
        let (x2, y2, z2) = (10., 20., 30.);
        let src1 = Vector3::new(x1, y1, z1);
        let src2 = Vector3::new(x2, y2, z2);
    ...
    #[test]
    fn ref_vector_add_vector_should_return_vector() {
        let (x1, y1, z1) = (1., 2., 3.);
        let (x2, y2, z2) = (10., 20., 30.);
        let src1 = Vector3::new(x1, y1, z1);
        let src2 = Vector3::new(x2, y2, z2);
    ...
    #[test]
    fn ref_vector_add_ref_vector_should_return_vector() {
        let (x1, y1, z1) = (1., 2., 3.);
        let (x2, y2, z2) = (10., 20., 30.);
        let src1 = Vector3::new(x1, y1, z1);
        let src2 = Vector3::new(x2, y2, z2);
    ...
    #[test]
    fn vector_add_f64_should_return_vector() {
        let f = 10.;
        let (x1, y1, z1) = (1., 2., 3.);
    ...
    #[test]
    fn ref_vector_add_f64_should_return_vector() {
        let f = 10.;
        let (x1, y1, z1) = (1., 2., 3.);
        let src = Vector3::new(x1, y1, z1);
        let dst = &src + f;
    ...
    #[test]
    fn f64_add_vector_should_return_vector() {
        let f = 10.;
        let (x1, y1, z1) = (1., 2., 3.);
        let src = Vector3::new(x1, y1, z1);
        let dst = f + src;
    ...
    #[test]
    fn f64_add_ref_vector_should_return_vector() {
        let f = 10.;
        let (x1, y1, z1) = (1., 2., 3.);
        let src = Vector3::new(x1, y1, z1);
        let dst = f + &src;
